...
var sanitizeValue = /* @__PURE__ */ __name((value, maxLength) => {
  if (typeof value !== "string") return "";
  return value.trim().slice(0, maxLength);
}, "sanitizeValue");
var parseAndValidateContactRequest = /* @__PURE__ */ __name((input) => {
...
var getClientIp = /* @__PURE__ */ __name((request) => request.headers.get("CF-Connecting-IP") || "unknown", "getClientIp");
var hashRateLimitKey = /* @__PURE__ */ __name(async (value) => {
  const encoded = new TextEncoder().encode(value);
  const digest = await crypto.subtle.digest("SHA-256", encoded);
  return [...new Uint8Array(digest)].map((byte) => byte.toString(16).padStart(2, "0")).join("");
}, "hashRateLimitKey");
var enforceRateLimit = /* @__PURE__ */ __name(async (request, env) => {
...
// ../.wrangler/tmp/pages-fPfxAe/functionsRoutes-0.21370042583664506.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-AcOKvZ/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-AcOKvZ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.31663766019398165.mjs.map
